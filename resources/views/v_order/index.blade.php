  ...
  <div class="container-bio d-flex mx-3 my-2">
    <div class="container-bio1 mx-4 " style="border: 3px solid #3B2621; border-radius: 5px;height: 400px;">
      <div class="nama d-flex p-2 align-items-center">
        ...
        <p class="text-start align-items-center p-3">{{ Auth::user()->name }}</p>
      </div>
      ...
      <div class="pembayaran p-2">
        ...
        <div class="saldo d-flex align-items-center">
            <img src="{{ asset('asset/image/pembayaran3.png') }}" alt="Saldo">
        ...
        @if ($orders->isEmpty())
          <div class="row">
            <div class="col-12">
              ...
              <div class="d-flex flex-column align-items-center justify-content-center" style="height: 200px; padding-top: 100px;"> <!-- Adjust height as needed -->
                <img src="{{ asset('asset/image/pesanan.png') }}" alt="Belum ada pesanan" class="img-fluid">
              ...
              <div class="col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <p class="card-text">Waktu Pengambilan: {{ $order->pickup_time }}</p>
                    <p class="card-text">Jenis Pengambilan: {{ $order->pickup_type }}</p>
                    <p class="card-text">Subtotal: Rp{{ number_format($order->subtotal, 0, ',', '.') }}</p>
                    <p class="card-text">Biaya Kemasan: Rp{{ number_format($order->packaging_fee, 0, ',', '.') }}</p>
