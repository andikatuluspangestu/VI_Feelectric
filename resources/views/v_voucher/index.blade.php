      ...
      <div class="container my-4 " >
        <div class="row">
            <div class="col-md-12 mx-2">
                ...
                <div class="container d-flex justify-content-center">
                    <img src="asset/image/voucher1.png" alt="Voucher Promotion 1" style="width: 350px;">
                    <img src="asset/image/voucher2.png" alt="Voucher Promotion 2" style="width: 350px;">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="header d-flex justify-content-between m-3">
                    <h5>Voucher Gratis Ongkir Harian</h5>
                ...
                <div class="d-flex align-items-center voucher-container">
                  ...
                  <div class="text-container p-3">
                    <p class="mb-1 small">Gratis Ongkir</p>
                    <p class="mb-1 small">Min. Blj Rp 50RB</p>
                    <p class="mb-2 small">Berlaku Hingga. 10 July S&K</p>
                  </div>
                    <button class="btn voucher-button ms-auto text-light mx-3" style="background-color: #3B2621;">Pakai</button>
                </div>
            </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <!-- Header outside the card -->
                <div class="header d-flex justify-content-between m-3">
                    <h5>Voucher Gratis Ongkir Mingguan</h5>
                    <a href="#" class="text-decoration-none">Selengkapnya</a>
                </div>
                <!-- Voucher card -->
                <div class="card m-3" style="border: 2px solid gainsboro;">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- Header outside the card -->
                <div class="header d-flex justify-content-between m-3">
                    <h5>Voucher Gratis Ongkir Bulanan</h5>
                    <a href="#" class="text-decoration-none">Selengkapnya</a>
                </div>
                <!-- Voucher card -->
                <div class="card m-3" style="border: 2px solid gainsboro;">
